...
def get_user_context(user_id, include_profile=True, include_user_profile=True,
                     include_preference=True, include_history=False,
    ...
    if include_history and start_date and end_date:
        ...
        if meals:
            ...
            for date_str, stats in daily_stats.items():
                ...
                food_list = [f"{m.food_name}({m.calories}卡)" for m in stats['foods']]
